...
async def investor_slides_agent(
    ...
    """Process investor slides queries.
    ...
    logger.info(
        "subagent.investor_slides.started",
    ...
    try:
        ...
        results = await retrieve_investor_slides(
        ...
        logger.error(
            "subagent.investor_slides.error",
            execution_id=execution_id,
            error=str(exc),
            exc_info=True,
        )
        ...
        yield _chunk(database_id, f"Error retrieving investor slides: {exc}")


async def retrieve_investor_slides(
    query_text: str,
    latest_message: str,
    bank_period_combinations: List[Dict[str, Any]],
    context: Dict[str, Any],
    ...
    """Retrieve and research investor slide evidence."""
