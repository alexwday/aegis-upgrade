...
async def transcripts_agent(
    ...
    """Process earnings transcript queries.
    ...
    try:
        ...
        results = await retrieve_transcripts(
        ...
        add_monitor_entry(
            ...
            decision_details=(
                ...
                f"{len(results['findings'])} findings from transcripts"
            ),
            custom_metadata={
        ...
        yield _chunk(database_id, f"Error retrieving transcripts: {exc}")
...
async def retrieve_transcripts(
    ...
    """Retrieve and research earnings transcript evidence."""
