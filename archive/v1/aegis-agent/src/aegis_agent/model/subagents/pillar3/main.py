...
async def pillar3_agent(
    ...
    try:
        ...
        results = await retrieve_pillar3(
        ...
        add_monitor_entry(
            ...
            decision_details=(
                ...
                f"{len(results['findings'])} findings from Pillar 3"
            ),
            custom_metadata={
        ...
        yield _chunk(database_id, f"Error retrieving Pillar 3: {exc}")


async def retrieve_pillar3(
    query_text: str,
    latest_message: str,
    bank_period_combinations: List[Dict[str, Any]],
    context: Dict[str, Any],
    ...
    """Retrieve and research Pillar 3 evidence."""
