...
from aegis_agent.v2.api import mount_v2_frontend, router as v2_router  # noqa: E402
from aegis_agent.v2.mock_data import mock_source_document_record  # noqa: E402
...
mount_v2_frontend(app, ROOT_DIR)
...
async def _load_source_document(source: str, file_id: str) -> Dict[str, Any]:
    ...
    mock_row = mock_source_document_record(source, file_id)
    ...
    try:
        ...
        logger.warning(
            "source_document.preview_unavailable",
            source=source,
            file_id=file_id,
            error=str(exc),
        )
