...
DATA_STAGING_TABLE_NAME = "aegis_investor_slides_data_load_stage"
EMBEDDINGS_STAGING_TABLE_NAME = "aegis_investor_slides_embeddings_load_stage"
...
def main(argv: list[str] | None = None) -> int:
    ...
    with psycopg2.connect(
        **db_config,
        application_name="aegis-investor-slides-load-master-csvs",
    ) as conn:
...
def _parse_args(argv: list[str] | None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Refresh public investor slide retrieval tables.",
    )
    parser.add_argument(
        "--env-file",
        type=Path,
