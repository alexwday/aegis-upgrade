...
DEFAULT_LOCAL_INPUT_PATH = Path("/Users/alexwday/Projects/aegis-upgrade/aegis-documents/investor_slides")
DEFAULT_LOCAL_OUTPUT_PATH = REPO_ROOT / "data-output" / "master"
DEFAULT_DATA_SOURCE = "investor-slides"
...
class PdfExtractionConfig:
    """Runtime controls for investor-slide PDF vision extraction.

    The raw OCR settings drive the single chat-completions vision request made
    for each rendered slide. Region and crop settings are retained as legacy
...
def get_pdf_extraction_config() -> PdfExtractionConfig:
    ...
    return PdfExtractionConfig(
        ...
        raw_ocr_model=_env("PDF_RAW_OCR_MODEL", "gpt-5.4"),
...
def get_base_path() -> Path | str:
    ...
    aegis-documents investor_slides folder. For NAS input, INPUT_BASE_PATH is the optional
