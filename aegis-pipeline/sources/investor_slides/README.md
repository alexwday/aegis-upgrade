# Aegis Investor Slides Pipeline

Pipeline for converting Canadian bank investor slide PDFs into retrieval-ready
...
inputs; place any additional source files under `data-input/investor-slides/`
...
- `LLM_MODEL_LARGE=gpt-5.4` for extraction and enrichment.
- `PDF_RAW_OCR_MODEL=gpt-5.4`.
- `PDF_RAW_OCR_REASONING_EFFORT=` unless your chat-completions endpoint
  accepts that optional parameter.
...
```text
data-input/investor-slides/
  2026_Q1/
    RY/
      rbc_q1_2026_investor_slides.pdf
    BNS/
      bns_q1_2026_investor_slides.pdf
```
...
```text
public."aegis-investor-slides-data"
public."aegis-investor-slides-embeddings"
```
