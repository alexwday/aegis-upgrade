...
- This directory may not be a Git repository. When possible, start Codex from `/Users/alexwday/Projects/aegis-financial-supp` so this file is loaded.
...
- Keep all work inside this workspace unless the user asks otherwise. Do not write outside `/Users/alexwday/Projects/aegis-financial-supp` without approval.
