...
- This workspace contains the earnings transcripts database pipeline under `database/`,
...
- This directory may not be a Git repository. When possible, start Codex from `/Users/alexwday/Projects/aegis-earnings-transcripts` so this file is loaded.
...
- Keep all work inside this workspace unless the user asks otherwise. Do not write outside `/Users/alexwday/Projects/aegis-earnings-transcripts` without approval.
