"""PostgreSQL connection helpers for the database module."""
...
def get_connection() -> PsycopgConnection:
    """Open a live PostgreSQL connection using database/.env settings.
    ...
    return psycopg2.connect(
        **config,
        ...
        application_name="aegis-earnings-transcripts-database",
    )
