...
DEFAULT_LOCAL_INPUT_PATH = Path("/Users/alexwday/Projects/aegis-upgrade/aegis-documents/transcripts")
DEFAULT_LOCAL_OUTPUT_PATH = REPO_ROOT / "data-output" / "master"
DEFAULT_DATA_SOURCE = "earnings-transcripts"
...
def get_base_path() -> Path | str:
    ...
    aegis-documents transcripts folder. For NAS input, INPUT_BASE_PATH is the optional
