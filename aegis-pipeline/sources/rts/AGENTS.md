...
- This workspace contains the report to shareholderss database pipeline under `database/`,
  copied from the financial supplement pipeline as its starting point.
...
- This directory may not be a Git repository. When possible, start Codex from `/Users/alexwday/Projects/aegis-report-to-shareholders` so this file is loaded.
...
- Keep all work inside this workspace unless the user asks otherwise. Do not write outside `/Users/alexwday/Projects/aegis-report-to-shareholders` without approval.
