...
This stage mirrors Aegis Retriever Stage 5 for both XLSX sheets and PDF pages.
It loads the chunking artifacts, treats every source item as one content
...
def _source_title(document: EnrichmentDocument) -> str:
    ...
    if data_source in {"rts", "report-to-shareholders"}:
        source_name = "Report to Shareholders"
