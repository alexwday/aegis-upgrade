...
DEFAULT_LOCAL_INPUT_PATH = Path("/Users/alexwday/Projects/aegis-upgrade/aegis-documents/rts")
DEFAULT_LOCAL_OUTPUT_PATH = REPO_ROOT / "data-output" / "master"
DEFAULT_DATA_SOURCE = "rts"
...
class PdfExtractionConfig:
    """Runtime controls for RTS PDF vision extraction.
...
def get_pdf_extraction_config() -> PdfExtractionConfig:
    ...
    return PdfExtractionConfig(
        ...
        raw_ocr_model=_env("PDF_RAW_OCR_MODEL", "gpt-5-mini"),
...
def get_base_path() -> Path | str:
    ...
    aegis-documents rts folder. For NAS input, INPUT_BASE_PATH is the optional
