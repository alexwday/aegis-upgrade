...
DEFAULT_LOCAL_INPUT_PATH = Path("/Users/alexwday/Projects/aegis-upgrade/aegis-documents/pillar3")
DEFAULT_LOCAL_OUTPUT_PATH = REPO_ROOT / "data-output" / "master"
DEFAULT_DATA_SOURCE = "pillar3"
...
def get_base_path() -> Path | str:
    ...
    aegis-documents pillar3 folder. For NAS input, INPUT_BASE_PATH is the optional
