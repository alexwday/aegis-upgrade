"""Extract Pillar 3 XLSX workbooks into inspectable artifacts.
...
def run_extraction_stage(
    ...
    Args:
        input_base_path: Optional local pillar3 input folder override.
...
def _resolve_input_base_path(input_base_path: Path | None) -> Path:
    """Resolve the local pillar3 input folder."""
