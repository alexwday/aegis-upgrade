"""Logging helpers for source pipeline modules."""
...
DEFAULT_LOGS_DIR = SOURCE_CONTEXT.logs_dir
DEFAULT_LOGGER_NAME = ""
HANDLER_MARKER = "_aegis_pipeline_handler"
...
def setup_logging(
    ...
    By default this configures the root logger so pipeline package loggers and
